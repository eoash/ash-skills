---
name: my-consult
description: EO Studio 어드바이저 자동 라우팅 메타 스킬. 입력 키워드를 감지해 Alex(코드), Lisa(법률), Chris(재무), Mia(디자인), Ryan(PM) 중 적합한 어드바이저에게 자동 라우팅. "상담해줘", "물어볼게", "/consult" 요청에 사용.
---

# my-consult

입력 내용을 분석해 **Alex / Lisa / Chris / Mia / Ryan** 중 가장 적합한 어드바이저에게 자동 라우팅하는 메타 스킬.
